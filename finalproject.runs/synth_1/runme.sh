...
HD_PWD='Z:/ECC/Desktop/Coen122L/finalproject/COEN122LFinal/finalproject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux_tb.tcl
